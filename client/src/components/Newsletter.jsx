...
const Newsletter = () => {
  return (
    <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            <Title title="Insider Perks" subTitle='Join our exclusive email list and unlock insider travel deals, special perks, and unforgettable stays across the globe.'/>
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
                ...
                <button className="flex items-center justify-center gap-2 group bg-slate-50 text-gray-800 px-4 md:px-7 py-2.5 rounded active:scale-95 transition-all">Subscribe
